...
//            passwordField.setBorder(BorderFactory.createLineBorder(Color.ORANGE, 2));
//
//        } else{
//            Color strongGreen = new Color(0, 200, 0);
//
//            resultArea.setForeground(strongGreen);
//            strengthBar.setForeground(strongGreen);
//            statusLabel.setForeground(strongGreen);
//            passwordField.setBorder(BorderFactory.createLineBorder(strongGreen, 2));
//        }
//
